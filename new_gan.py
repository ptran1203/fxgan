...
class BalancingGAN:
    ...
    def build_res_unet(self):
        ...
        en_1 = Concatenate()([
                en_1,
                Reshape((32,32,128))(RepeatVector(32*32)(latent_code))
            ])         
        ...
        de_1 = InstanceNormalization()(de_1)
        ...
        de_2 = InstanceNormalization()(de_2)
        de_2 = Activation('relu')(de_2)
        de_2 = Dropout(0.3)(de_2)
        # de_2 = Add()([de_2, en_2])

        de_3 = self._res_block(de_2)
        de_3 = Conv2DTranspose(192, 3, strides = 2, padding = 'same')(de_3)
        de_3 = InstanceNormalization()(de_3)
    ...
    def __init__(self, classes, target_class_id,
        ...
        re_latent = self.latent_encoder(fake)
    ...
    def _train_one_epoch(self, bg_train, from_p = False):
        ...
        for image_batch, label_batch, image_batch2, label_batch2 in bg_train.next_batch():
            ...
            ################## Train Generator ##################
            shuffle_image_batch, _ = self.shuffle_data(image_batch, label_batch)
